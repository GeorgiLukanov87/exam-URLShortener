...
#"DefaultConnection": "Server=georgi87-sqlserver;Database=georgi87-db;User Id=sa;Password=myStrongPassword12#;MultipleActiveResultSets=true;"
...
resource "azurerm_app_service_source_control" "sc_github" {
